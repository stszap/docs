...
is completely open source and located [here](https://github.com/ory/metrics-middleware). If you do not wish to help
us improving our products by sharing telemetry data, it is possible to [turn off this feature](#disabling-telemetry).
